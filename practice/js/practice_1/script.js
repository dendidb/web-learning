...
hasil.onclick = function(even) {
  ...
  document.getElementById('total').innerText = 'Total' + ' ' + ':' + hasil.value;
  document.getElementById('hargaTotal').value = Number(harga.value) - (Number(harga.value) * diskon.value / 100);
}
