...
function keluarkanData(value){
  ...
  if (value['discount'] != undefined) {
    elementDiskon = '<p class="product-percent">' + value.discount + '%' + '</p>';
    elementHargaDiskon = '<p class="product-discount">' + '<del>' + formatRupiah(discount(value.harga, value.discount), '')+ '</del>' + '</p>';
  }
